...
import { sleepPreventionActive, sleepPreventionProcess, setSleepPreventionActive, setSleepPreventionProcess, opencodePanel } from '../../core/state';
    ...
    try {
        ...
        switch (platform) {
            ...
            case 'linux':
                ...
                args = ['--what=sleep:idle', '--who=OpenCodeAutopilot', '--why=Waiting for OpenCode usage limit reset', 'sleep', '7200'];
                break;
            default:
        ...
        vscode.window.showInformationMessage('Sleep prevention enabled while waiting for OpenCode usage limit reset');
