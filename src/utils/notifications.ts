...
export const Messages = {
    // Session messages
    SESSION_ALREADY_RUNNING: 'OpenCode session is already running',
    SESSION_STARTED: 'OpenCode session started successfully',
    SESSION_STOPPED: 'OpenCode session stopped',
    
    // Queue messages
    MESSAGE_ADDED: 'Message added to OpenCode queue',
    ALL_MESSAGES_PROCESSED: 'All messages processed. OpenCode session remains active. Add messages to continue.',
    ...
    FAILED_TO_START_SESSION: 'Failed to start OpenCode session',
    ...
    FAILED_AUTO_START_SESSION: 'Failed to auto-start OpenCode session'
} as const;