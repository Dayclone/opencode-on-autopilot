/**
 * Centralized UI strings and status messages for the OpenCode Autopilot extension
 */
...
export const SessionMessages = {
    STARTING: 'Starting OpenCode session',
    STARTED: 'OpenCode session started',
    STOPPING: 'Stopping OpenCode session',
    STOPPED: 'OpenCode session stopped',
    READY: 'Session ready',
